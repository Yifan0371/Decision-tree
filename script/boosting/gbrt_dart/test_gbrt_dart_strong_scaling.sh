...
# ==============================================================================
# script/boosting/gbrt_dart/test_gbrt_dart_strong_scaling.sh
# GBRT DART Strong-scaling test – 固定数据规模，按线程数测试耗时和MSE
# ==============================================================================
...
LOGFILE="$SCRIPT_DIR/gbrt_dart_strong_scaling_$(date +%Y%m%d_%H%M%S).log"
echo "日志文件: $LOGFILE"
echo "===============================================" >> "$LOGFILE"
echo "GBRT DART Strong Scaling Performance Test Log" >> "$LOGFILE"
...
# 6) 打印表头
echo "==============================================="
echo "   GBRT DART Strong Scaling Performance Test   "
echo "==============================================="
...
echo ""
echo "==============================================="
echo "DART Strong Scaling Analysis:"
echo "- 理想: 线性加速，时间反比于线程数"
echo "- 关注点: TestMSE 保持稳定，Elapsed 时间下降"
echo "- 效率 = (串行时间 / 并行时间) / 线程数"
echo ""
echo "DART特有特性:"
echo "- Dropout操作增加额外计算开销"
echo "- 权重更新可能成为串行瓶颈"
echo "- 树间依赖性限制并行效果"
echo "- 预期效率略低于标准GBRT (0.6-0.8)"
echo "==============================================="
